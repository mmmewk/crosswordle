              ...
              <div>
                <div className="text-center">
                  ...
                  <div className="mt-2">
                    ...
                    <div className="flex mb-1 mt-4 items-center">
                      <div className='grow mr-2'>
                        <Key value="அ" crossedStatus='absent'/>
                      </div>
